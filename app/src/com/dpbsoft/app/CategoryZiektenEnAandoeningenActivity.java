...
public class CategoryZiektenEnAandoeningenActivity extends CategoryActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnGoedeDoelen.setOnClickListener(new View.OnClickListener() {
		      ...
		      public void onClick(View view) {
		    	  Intent intent = new Intent(CategoryZiektenEnAandoeningenActivity.this, ListCharitiesActivity.class);
