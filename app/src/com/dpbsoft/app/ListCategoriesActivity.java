...
public class ListCategoriesActivity extends ListActivity {
	...
	static final String[] FRUITS = new String[] { "Categorie 1", "Categorie 2", "Categorie 3",
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setListAdapter(new ArrayAdapter<String>(this, R.layout.activity_list_categories,FRUITS));
